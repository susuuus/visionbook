...
<figure id="fig:lightRay">
<embed src="figures/taxonomy/lightGray2.pdf" />
<p>(a)(b)(c)</p>
<figcaption>(a) Scene illuminated with a ceiling lamp. (b-c) Two images
obtained by illuminating a scene with a laser pointer (the red line
indicates the direction of the ray).</figcaption>
</figure>
...
pattern of light rays that fills the space. \[.5in\] The plenoptic
function does not include information about the observer. The observer
...
](figures/taxonomy/measuringScene2.eps){#fig:measuringScene
width="1\\linewidth"}
...
reached the scene. He listed the following seven axioms of light,
extracted from @Burton1945:
...
](figures/taxonomy/euclid.eps){#fig:euclid width="0.6\\linewidth"}
...
directions. shows a schematic illustration of Helmholtz's opthalmoscope,
...
<figure id="fig:helmholtz">

<figcaption>Hermann von Helmholtz invented the ophthalmoscope at age 29.
Images from .</figcaption>
</figure>
...
Kohler.](figures/taxonomy/gestalt.eps){#fig:gestalt
width="1\\linewidth"}
...
the ring are
identical.](figures/taxonomy/koffka_ring.eps){#fig:koffka_ring
width="1\\linewidth"}
...
the triangle sides.](figures/taxonomy/kanizsa.eps){#fig:kanizsa
width="1\\linewidth"}
...
@Gibson1966.](figures/taxonomy/gibson_bird.eps){#fig:gibson_bird
width="0.7\\linewidth"}
...
\[-.3in\] is very impoverished and that perception is **indirect** as it
...
Cajal.](figures/taxonomy/cajal.eps){#fig:cajal width=".6\\linewidth"}
...
moment the bar is
visible.](figures/taxonomy/receptive_fields.eps){#fig:receptivefields
width="1\\linewidth"}
...
from
@kandel:neural.](figures/taxonomy/visual_pathways_aina.eps){#fig:visual_pathways
width=".7\\linewidth"}
...
Figure recreated from
@Marr82.](figures/taxonomy/necker.eps){#fig:necker_cube
width=".9\\linewidth"}
...
from @Marr82.](figures/taxonomy/sketch.eps){#fig:sketch
width=".9\\linewidth"}
...
.](figures/taxonomy/programming_vs_learning.pdf){#fig:taxonomy:programming_vs_learning
width="1\\linewidth"}
...
next?](figures/taxonomy/neural_net_enthusiasm.eps){#fig:taxonomy:neural_net_enthusiam
width="0.7\\linewidth"}
...
detect faces in photos @Viola01. \[-1.25in\] This method outperformed
...
competition @russakovsky2015imagenet. \[-.8in\] The ImageNet moment was
