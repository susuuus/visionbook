...
](figures/taxonomy/measuringScene2-1.png){#fig-measuringScene
width="100%"}
...
](figures/taxonomy/euclid-1.png){#fig-euclid width="60%"}
...
Kohler.](figures/taxonomy/gestalt-1.png){#fig-gestalt width="100%"}
...
the ring are
identical.](figures/taxonomy/koffka_ring-1.png){#fig-koffka_ring
width="100%"}
...
the triangle sides.](figures/taxonomy/kanizsa-1.png){#fig-kanizsa
width="100%"}
...
![](figures/taxonomy/gibson_cover_the_perception_of_visual_world-1.png){width=".3"}
...
@Gibson1966.](figures/taxonomy/gibson_bird-1.png){#fig-gibson_bird
width="70%"}
...
![](figures/taxonomy/receptive_field-1.png){width=".4"}
...
moment the bar is
visible.](figures/taxonomy/receptive_fields-1.png){#fig-receptivefields
width="100%"}
...
from
@kandel:neural.](figures/taxonomy/visual_pathways_aina-1.png){#fig-visual_pathways
width="80%"}
...
Figure recreated from
@Marr82.](figures/taxonomy/necker-1.png){#fig-necker_cube
width=".9"}
...
from @Marr82.](figures/taxonomy/sketch-1.png){#fig-sketch
width=".9"}
...
next?](figures/taxonomy/neural_net_enthusiasm-1.png){#fig-taxonomy:neural_net_enthusiam
width="70%"}
