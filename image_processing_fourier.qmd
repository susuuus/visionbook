# Fourier Analysis {#chapter-fourier_analysis}
...
$\mathbf{x}$. This representation is specially interesting when it can
...
![](figures/Image_processing_fourier/FourierSeries6-1.png){width="100%"}
...
![](figures/Image_processing_fourier/FourierSeries5_representation-1.png){width=".9"}
...
The representation using Fourier series is important for studying linear
...
$\sqrt{u^2+v^2}$, and orientation, $\angle (u,v)$.
...
\end{bmatrix}$$ Each entry in the matrix is
...
![](figures/Image_processing_fourier/visualization_DFT_color-1.png){width="70%"}
...
![](figures/Image_processing_fourier/dft_a-1.png){width="100%"}
...
![](figures/Image_processing_fourier/dft_b-1.png){width="100%"}
...
![](figures/Image_processing_fourier/DFT_examples_waves-1.png){width="100%"}
...
![](figures/Image_processing_fourier/DFT_toy_examples-1.png){width="100%"}
...
function: $$\text{box}_{L} \left[n \right]\xrightarrow{\mathscr{F}} 
\frac{\sin \pi u (2L+1)/N}{\sin \pi u/N}$$ We will denote the DFT of the
box function, $\text{box}_{L} \left[n \right]$, capitalizing the first
...
It is important to be familiar with the properties for the DFT. Table
[\[table:tableDFT\]](#table:tableDFT){reference-type="ref"
reference="table:tableDFT"} summarizes some important transforms and
properties.

::: center
                 **$\ell\left[ n \right]$**                                            **$\mathscr{L}\left[u \right]$**
  --------------------------------------------------------- ---------------------------------------------------------------------------------------
   $\ell_1 \left[ n \right] \circ \ell_2 \left[ n \right]$               $\mathscr{L}_1 \left[u \right] \mathscr{L}_2 \left[u \right]$
     $\ell_1 \left[ n \right]$ $\ell_2 \left[ n \right]$        $\frac{1}{N} \mathscr{L}_1 \left[u \right] \circ \mathscr{L}_2 \left[u \right]$
                 $\ell\left[ n-n_0 \right]$                      $\mathscr{L}\left[u \right] \exp{ \left( - 2 \pi j \frac{u n_0}{N} \right) }$
       ...
       $\sin{ \left( 2 \pi u_0 \frac{n}{N} \right) }$        $\frac{1}{2j} \left( \delta \left[u-u_0 \right] -  \delta \left[u+u_0\right] \right)$
              $\text{box}_{L} \left[n \right]$                                    $\frac{\sin \pi u (2L+1)/N}{\sin \pi u/N}$
:::

[]{#table:tableDFT label="table:tableDFT"}
...
:::
 ...
 We will discuss this in more detail in section
[1.10](#sect:transfer_function){reference-type="ref"
reference="sect:transfer_function"}.
...
![](figures/Image_processing_fourier/shiftFT2-1.png){width="100%"}
...
![](figures/Image_processing_fourier/modulation-1.png){width="100%"}
...
![](figures/Image_processing_fourier/amp_phase_swap_color-1.png){width="100%"}
...
[\[chapter-stat_image_models\]](#chapter:stat_image_models){reference-type="ref"
...
![](figures/Image_processing_fourier/dft_random_phaseandamplitude-1.png){width="100%"}
...
![](figures/Image_processing_fourier/FTgame-1.png){width="100%"}
...
![](figures/Image_processing_fourier/filter-types-1.png){width=".9"}
...
![](figures/Image_processing_fourier/mit_columns-1.png){width="100%"}
