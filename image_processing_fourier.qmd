...
property from section -section:dualconv. Note that now the result in equation
...
observed contours and edges. In fact, as shown in @section:DFTproperties, translating the image in space only
...
![An image filtered by (left) low-pass, (middle) band-pass, and (right) high-pass filters.](figures/linear_image_filtering/sketch_coarse.jpg){width=".3" #fig-sketchresponses}
