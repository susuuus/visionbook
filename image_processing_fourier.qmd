...
:::{.column-margin}
![](figures/Image_processing_fourier/amplitudeandperiod.png){width="50%"}
:::
...
:::{.column-margin}
**Separability**. Although almost all images are not separable, some can be approximated by a separable image. Here is one example.
...
![](figures/Image_processing_fourier/facade1.jpg){width="40%"}

![](figures/Image_processing_fourier/facade1aprox.jpg){width="40%"}
...
![](figures/Image_processing_fourier/con1.png){width="60%"}
...
![](figures/Image_processing_fourier/con2.png){width="60%"}
...
![](figures/Image_processing_fourier/experimental_setup.jpg){}
:::
...
![](figures/Image_processing_fourier/H.png){width="80%"}
...
![](figures/spatial_filters/my_CST.png)
