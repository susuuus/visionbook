...
![(top row): $k$-means segmentation succeeds on a seemingly hard image. \textit{Photo source](./figures/perceptual_organization/kmeans_ab_zebra_and_beach.png){width="100%" #fig-perceptual_organization-kmeans_ab_zebra_and_beach}
...
![Image segmentation using $k$-means over DINO~\cite{caron2021emerging](./figures/perceptual_organization/kmeans_dino.png){width="100%" #fig-perceptual_organization-kmeans_dino}
