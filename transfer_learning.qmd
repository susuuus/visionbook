...
:::{.column-margin}
We will use the symbol ![](.figures/transfer_learning/lock.png){width="10px"} to indicate a frozen module and the symbol ![](.figures/transfer_learning/fire.png){width="10px"} to indicate a module that is updated during the adaptation phase.
:::
...
![](./figures/transfer_learning/fig-transfer_learning-learning_from_examples.png){width="100%" #fig-transfer_learning-learning_from_examples}
...
![](./figures/transfer_learning/fig-transfer_learning-learning_from_teacher.png){width="100%" #fig-transfer_learning-learning_from_teacher}
...
adversarial noise we covered in @sec-bias_and_shift-adversarial_attacks.  However,
