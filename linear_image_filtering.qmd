...
![System processing one signal.](figures/linear_image_filtering/genericfilterH.png){#fig-genericfilterH width="60%"}
...
![](figures/linear_image_filtering/mn1.png){width="40%"}

The signal $\ell \left[n - n_0\right]$ is a shifted version of $\ell \left[n\right]$. With $n_0 = 2$ this is


![](figures/linear_image_filtering/mn2.png){width="40%"}
:::
...
![](figures/linear_image_filtering/mn3.png){width="40%"}
