# 3D Motion and Its 2D Projection {#chapter-3D_motion_and_its_2D_projection}
...
![](figures/optical_flow/basic_motion_point-1.png){width=".5"}
...
![](figures/optical_flow/examples_3d_moving_points-1.png){width="100%"}
...
![](figures/optical_flow/flying_bird-1.png){width="100%"}
...
![](figures/optical_flow/camera_lateral_translation-1.png){width="100%"}
...
![](figures/optical_flow/camera_lateral_translation_flow-1.png){width="100%"}
...
![](figures/optical_flow/camera_forward_translation-1.png){width="100%"}
...
![](figures/optical_flow/camera_forward_translation_flow-1.png){width="100%"}
...
![](figures/optical_flow/yaw_pitch_roll-1.png){width=".4"}
...
![](figures/optical_flow/motion_wz-1.png){width=".4"}
...
![](figures/optical_flow/camera_motion_field_rotation_three_f-1.png){width="100%"}
...
[\[chapter-imaging\]](#chapter:imaging){reference-type="ref"
reference="chapter-imaging"}, in this chapter we have focused on
...
reference="chapter-motion_estimation"}, and we will study how to
