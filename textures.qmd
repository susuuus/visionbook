...
![Texture discrimination using textons.](figures/heeger_bergen/julez.png){width=".9" #fig-julez_texture}
...
%Texture analysis (encoder) using a steerable pyramid with 4 orientations and 3 scales. The output representation is the concatenation of the 12 subband histograms, the low-pass residual histogram and the input image histogram.](figures/heeger_bergen/analysis_heeger_bergen.png){width=".8" #fig-analysis_heeger_bergen}
...
![The steps of the Heeger-Bergen texture synthesis algorithm. The process starts with white noise input image. Each step takes as input the previous output, and it is modified by a function $f_{\theta](figures/heeger_bergen/heeger_bergen_iterations.png){width="100%" #fig-heeger_bergen_iterations}
...
dominant (-sect:Efros-Leung_texture) until generative models with
...
![In the Efros-Leung algorithm \cite{Efros99](figures/heeger_bergen/sampling_efros_leung.png){width="100%" #fig-sampling_efros_leung}
...
region enforces all the spatial regularities of the input texture.
  ...
  ---------------------------------------------------------------------
   ![Synthesized texture from the Efros-Leung algorithm \cite{Efros99](figures/statistical_image_models/efros1a.jpg){width="10%" #fig-efros1}
                                  \(a\)
  ---------------------------------------------------------------------
