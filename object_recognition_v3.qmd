...
[\[chapter-bias_and_shift\]](#sec-bias_and_shift){reference-type="ref"
...
@fig-box_table.
  ...
  ------------------------------------------------------------------
   ![The same object can have different occasion meanings depending on the context. (a) A box. (b) A box used as a table.](figures/object_recognition/box_box2.jpg){width="47.5%" #fig-box_table}
                                \(a\)
  ------------------------------------------------------------------
...
![Which of these images contains a car? This is a simple question that does not have a simple answer.](figures/object_recognition/IMG_1260.jpeg){width="32%" #fig-whatisacar}
...
reference="sec-textures"}). But the distinction between stuff and
