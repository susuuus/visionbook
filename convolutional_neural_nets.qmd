...
We already saw that convolutional filters are useful for image processing in @part-image_processing and @sec-linear_filters. In those sections, we introduced a variety of hand-designed filter banks with useful properties. A CNN instead *learns* an effective filter bank.
