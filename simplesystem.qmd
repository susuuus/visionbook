...
world!](figures/simplesystem/simpleObjects.pdf){#fig:simpleObjects
width="1\\linewidth"}
...
projection.](figures/simplesystem/parallelProjection.pdf){#fig:parallelProjection
width="1\\linewidth"}
...
sign change and a
scaling.](figures/simplesystem/projection2.eps){#fig:projection
width="1\\linewidth"}
...
The observed image is a function, $$\img(x,y)$$ that takes as input
...
array of pixel intensities, $\img(x,y)$, is a reasonable representation
...
surface albedo, and
shadows).](figures/simplesystem/edgeLabeling.pdf){#fig:edgeLabeling
width=".9\\linewidth"}
...
geometry. If we think of the image $\img (x,y)$ as a function of two
...
values of the $\img (x,y)$ at discrete locations (pixels). Therefore, we
...
<embed src="figures/simplesystem/gradient.pdf" />
<embed src="figures/simplesystem/edgeTypes.pdf" />
...
another.](figures/simplesystem/ground_figure_points.eps){#fig:ground_figure_points
width=".5\\linewidth"}
...
](figures/simplesystem/accidentalAlignments.pdf){#fig:accidentalAlignments
width="1\\linewidth"}
...
images.](figures/simplesystem/worldCoordinates.pdf){#fig:worldCoordinates
width="1\\linewidth"}
...
viewpoints.](figures/simplesystem/views.pdf){#fig:views
width="1\\linewidth"}
...
](figures/simplesystem/out_of_domain_example.eps){#fig:out_of_domain
width="1\\linewidth"}
...
perception.](figures/simplesystem/steps.pdf){#fig:impossible
width="1\\linewidth"}
