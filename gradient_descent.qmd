...
![Using @alg-gradient_descent-ES) to minimize a nondifferentiable (zero-gradient) loss, using $\sigma=1$, $M=10$, and $\eta=0.02$.](./figures/gradient_descent/sampling_out1.png){#fig-gradient_descent-sampling_out1 width=80%}
