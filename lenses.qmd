...
in figures (@fig-pinholes) and @fig-pinholeSize, one can try to let in more light by making
...
The middle row of table @tab-lensmaker requires explanation. The light ray within
...
table @tab-lensmaker for $\theta_4$, and substitute for each angle
...
#eq-lensmaker}$$ where the lens **focal length**, $f$ is defined
...
:::{#fig-ConcaveLenses}
<figcaption>
(a) A convex lens focuses rays to a point. (b) A concave
