...
on-axis point, $P_0$.](figures/imaging/offAxis.png){#fig-rotatedLens
width="100%"}
...
@Levoy2010.](figures/imaging/circleOfConfusion-1.png){#fig-circleOfConfusion
width="70%"}
...
plane.](figures/imaging/dof.png){#fig-DOFformula width="100%"}
