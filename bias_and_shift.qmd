...
![Each pair of images shows the grayscale input image and, to its right, the output of the automatic colorization system. Source: \cite{zhang2016colorful](./figures/bias_and_shift/CIC_teaser_v5.jpg){width="100%" #fig-bias_and_shift-CIC_teaser}
...
![Two results of Reddit's ColorizeBot~\cite{colorizebot_blog](./figures/bias_and_shift/colorizebot_examples.png){width="70%" #fig-bias_and_shift-colorizebot_examples}
...
![(left) Colorization results, using a model trained on ImageNet (example made by Richard Zhang; input black and white photos from ImageNet~\cite{russakovsky2015imagenet](./figures/bias_and_shift/dogs_with_tongues.png){width="90%" #fig-bias_and_shift-dogs_with_tongues}
...
![Generalization error as a function of number of training examples. Test set is dataset A. Each curve shows the performance when training with dataset A and with dataset B (same distributions as in \fig{\ref{fig-bias_and_shift-training_test_sets](figures/bias_and_shift/toy_example/test_as_function_of_data.png){width="60%" #fig-bias_and_shift-test_as_function_of_data}
...
![Let's play the {\em Name That Dataset!](figures/bias_and_shift/datasetsJeopardy.png){width="100%" #fig-bias_and_shift-datasetsJeopardy}
...
![Cannonical viewpoints for 12 objects. Figure from \cite{Palmer1981](figures/bias_and_shift/palmer_1981enhanced.jpg){width="100%" #fig-bias_and_shift-palmer_1981enhanced}
...
revisit chapter
[\[chapter-computer_vision_and_society\]](#sec-computer_vision_and_society){reference-type="ref"
...
reference="sec-downsampling_and_upsampling"} we showed how aliasing
...
. In chapter
[\[chapter-data_augmentation\]](#sec-data_augmentation){reference-type="ref"
