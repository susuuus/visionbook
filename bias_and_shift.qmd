...
![](figures/bias_and_shift/toy_example/training_test_sets.png){width="100%"}
...
![](figures/bias_and_shift/toy_example/test_as_function_of_data.png){width="60%"}
...
![](figures/bias_and_shift/datasetsJeopardy.png){width="100%"}
...
![](figures/bias_and_shift/mugs.png){width="100%"}
...
![](figures/bias_and_shift/horses.png){width="100%"}
