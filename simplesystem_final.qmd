...
![(a) Input image and text prompt to ChatGPT. (b) Output by ChatGPT (Gpt4-v, version from Nov 21, 2023) when asked to describe the image from the simple world.](figures/simplesystem_revisited/chatgpt_blockworld.png){width="100%"}
...
![Output by ChatGPT when asked to render a new image with the same elements as in @fig-chatgpt_blockworld This conversation is a continuation of the same chat from @fig-chatgpt_blockworld](figures/simplesystem_revisited/chatgpt_blockworld_2.png){width=".5" #fig-chatgpt_blockworld2}
...
:::{.column-margin}
![](figures/simplesystem_revisited/conclusion_by_gpt4v.png){width="80%"}
:::
...
![](figures/simplesystem_revisited/gibson_bird.png){width="6%"}
