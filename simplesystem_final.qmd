# A Simple Vision System---Revisited {#chap-simple_system_revisited}
...
![](figures/simplesystem_revisited/img1.jpg){width="40%"}
...
![](figures/simplesystem_revisited/examples_training_midas.jpg){width="100%"}
...
\end{bmatrix}.
\end{aligned}$$
![](figures/simplesystem_revisited/projection-revisted-1.png){width=".24"}
...
![](figures/simplesystem_revisited/views_midas.jpg){width="100%"}
...
![](figures/simplesystem_revisited/chatgpt_blockworld-1.png){width="100%"}
...
![](figures/simplesystem_revisited/chatgpt_blockworld_2-1.png){width=".5"}
...
![](figures/simplesystem_revisited/gibson_bird-1.png){width=".06"}
