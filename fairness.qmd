# Computer Vision and Society {#chapter-computer_vision_and_society}
...
<figcaption>Images of household items, and their recognized classes by
...
the right two photographs.</figcaption>
</figure>
...
<figure id="fig:augmentation">

<figcaption>In this example “wears hat” is deemed to be a protected
attribute, but it is correlated with another attribute, which in this
example is “wears glasses” . The GAN-based method generates sets of
...
<figure id="fig:transect">

<figcaption> A GAN creates sequences of faces, called
<span><strong>transects</strong></span>, where only one attribute
changes . </figcaption>
</figure>
