...
(a) ![(a) Nearest neighbors, in autoencoder embedding space, to a set of query images. (b) Classification accurracy of a one-nearest-neighbor classifier of color and shape using the embeddings at each layer of the autoencoder's encoder.](figures/representation_learning/AE_NN_viz.png){width="38%" #fig-representation_learning-AE_results_shapes_dataset}
(b)
