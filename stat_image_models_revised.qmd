# Statistical Image Models {#chapter-stat_image_models}
...
![](figures/statistical_image_models/spaces_real_images-1.png){width=".8"}
...
![](figures/statistical_image_models/worlds-1.png){width="100%"}
...
![](figures/statistical_image_models/noiseInTheWorld-1.png){width="100%"}
...
![](figures/statistical_image_models/model_training_vs_sampling-1.png){width=".75"}
...
![](figures/statistical_image_models/model_hist_example2-1.png){width="100%"}
...
![](figures/statistical_image_models/4_examples_images-1.png){width="100%"}
...
![](figures/statistical_image_models/illuminationHistograms-1.png){width="100%"}
...
![](figures/statistical_image_models/correlation-1.png){width="100%"}
...
![](figures/statistical_image_models/dead_leaves_squares_and_circles-1.png){width="100%"}
...
![](figures/statistical_image_models/FT_power_law_angular2-1.png){width="100%"}

We will now use this observation to build a better statistical model of
images than using pixel histograms as we described in section
[1.3](#sec-independent_pixels){reference-type="ref"
reference="sec-independent_pixels"}.
...
![](figures/statistical_image_models/figure_samples_1_over_f-1.png){width="100%"}
...
![](figures/statistical_image_models/4_examples_images_color_FT-1.png){width="100%"}
...
![](figures/statistical_image_models/denoisingGaussianModel-1.png){width="100%"}
...
![](figures/statistical_image_models/figure_histograms_derivatives_street-1.png){width="100%"}
...
![](figures/statistical_image_models/examplesderivativedistributions-1.png){width="100%"}
...
![](figures/statistical_image_models/shapes_generalized_laplacian-1.png){width="100%"}
...
![](figures/statistical_image_models/best_a_s1-1.png){width=".6"}
...
![](figures/statistical_image_models/wavelet_denoising-1.png){width=".9"}
...
reference="chap-textures"}). We will focus here on a similar algorithm
...
![](figures/statistical_image_models/spaces_real_images_and_models_final-1.png){width="100%"}
...
[^1]: Additive stationary noise is noise with statistical properties
    ...
    section
    [1.5.2](#sec-image_denoising_gaussian_model){reference-type="ref"
    reference="sec-image_denoising_gaussian_model"} for a more precise
    definition.
