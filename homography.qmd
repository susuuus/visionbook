...
![These two images are (approximately) related by an homography.](figures/homography/IMG_7801_crop.jpg){width=".455" #fig-illustration_homography}
  
...
![Three pictures taken by rotating the camera while trying to keep the camera center fixed.](figures/homography/3_IMG_7883_small.jpg){width="44.5%" #fig-example_three_images}
...
![Two pictures of a building facade taken from different positions. The coordinates of corresponding points on the planar facade are related by a homography.](figures/homography/IMG_7127_crop.jpg){width="45%" #fig-example_two_images_facade}
...
![Panoramic image composed by the three overlapping images from \fig{\ref{fig:example_three_images](figures/homography/panorama.jpg){width="100%" #fig-panorama}
