...
![Homography. Colinear points remain colinear after transformation. Angles between lines are not preserved.](figures/homography/example_homography.png){width=".7" #fig-illustration_homography2}
