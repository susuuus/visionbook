...
![](figures/Image_processing_sampling/aliasing_1.jpg){width="50%" #fig-alaising-a}


![](figures/Image_processing_sampling/aliasing_2.jpg){width="50%" #fig-aliasing-b}
...
![A band-limited signal with maximum frequency $w_{max}$.](figures/Image_processing_sampling/band_limited_signal.png){#fig-band_limited_signal width="30%"}
