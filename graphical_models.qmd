# Probabilistic Graphical Models {#chapter-probabilistic_graphical_models}
...
as the pair shown in
figures [\[fig:canoe1\]](#fig-canoe1){reference-type="ref"
reference="fig:canoe1"}(a and b) and with their insets marked with the
red rectangles, shown in
figures [\[fig:canoe1\]](#fig-canoe1){reference-type="ref"
reference="fig:canoe1"}(c and d). Assume that the two images have been
rectified, as described in chapter
[\[chap-stereo_vision\]](#chap:stereo_vision){reference-type="ref"
reference="chap-stereo_vision"}, and consider the common scanline,
marked in figures [\[fig:canoe1\]](#fig-canoe1){reference-type="ref"
reference="fig:canoe1"}(c and d) with a black horizontal line. The
luminance intensities of each scanline are plotted in
figures [\[fig:canoe1\]](#fig-canoe1){reference-type="ref"
reference="fig:canoe1"}(e and f). Most computer vision stereo algorithms
...
only one scanline pair at a time.
  ...
  ---------------------------------------------------------------
   ![](figures/graphical_models/lcanoebig.jpg){width="40%"}
                               \(a\)
  ---------------------------------------------------------------
...
![](figures/graphical_models/stereomodel2.jpg){width="80%"}
...
3.  Run the belief propagation update rules of section
    [1.6.1](#sect:bpRules){reference-type="ref"
    reference="sect:bpRules"} until convergence.
