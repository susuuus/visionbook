...
![](figures/graphical_models/leaf2.jpg){width="2.3in" #fig-leafs-a}

![](figures/graphical_models/leaf1.jpg){width="2.5in" #fig-leafs-b}
...
![Summary of the messages (partial sums) for a simple belief propagation example.](figures/graphical_models/3bpc2.png){width="50%" #fig-3bpc}
...
![Pictorial depiction of belief propagation message passing rules of equation (@eq-bpupdate), where $\hadamard$ indicates elementwise multiplication (i.e., the Hadamard product).](figures/graphical_models/bpdiscrete1.png){width="48%" #fig-bpdiscrete}
...
![](figures/graphical_models/lcanoebig.jpg){width="40%" #fig-canoe1-a}

![](figures/graphical_models/rcanoebig.jpg){width="40%" #fig-canoe1-b}

![](figures/graphical_models/lcanoe2.jpg){width="40%" #fig-canoe1-c}

![](figures/graphical_models/rcanoe2.jpg){width="40%" #fig-canoe1-d}
