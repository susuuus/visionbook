...
![To compute the marginal probability at node $i$, we multiply
 together all the incoming messages at that node:  
$p_{i](figures/graphical_models/bpi.png){width="48%" #fig-bpi}
...
single node.
  ...
  ----------------------------------------------------------
   ![{\bf Synchronous parallel update schedule](figures/graphical_models/man1.png){width="20%" #fig-men}
                            \(a\)
  ----------------------------------------------------------
  ...
  --------------------------------------------------------------
   ![{\bf Depth-first BP message passing schedule](figures/graphical_models/rootman1.png){width="20%" #fig-men2}
                              \(a\)
  --------------------------------------------------------------
...
![Belief propagation applied to graphical model, \fig{\ref{fig-canoe3](figures/graphical_models/bpcanoes5.png){width=".8" #fig-canoe4}
