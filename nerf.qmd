...
reference="chap-challenge_of_vision"}) that postulated that light is
...
[\[chap-challenge_of_vision\]](#chap:challenge_of_vision){reference-type="ref"
reference="chap-challenge_of_vision"}.
...
![](figures/nerfs/plenoptic_function-1.png){width="100%"}
...
In chapter
[\[chap-challenge_of_vision\]](#chap:challenge_of_vision){reference-type="ref"
reference="chap-challenge_of_vision"} we discarded the plenoptic
...
rendering, which we will learn about in section
[1.4](#sec-nerfs:volume_rendering){reference-type="ref"
reference="sec-nerfs:volume_rendering"}. Radiance fields come in a
...
![](figures/nerfs/flatland_cameras_and_images.png){width="65%"}
...
![](figures/nerfs/flatland_implicit_to_explicit_v2.png){width="100%"}
...
-   **Optical flow fields**, $f: x, y, t \rightarrow u, v$, measure
    ...
    [\[chapter-3D_motion_and_its_2D_projection\]](#chapter:3D_motion_and_its_2D_projection){reference-type="ref"
...
![](figures/nerfs/flatland_positional_encoding.png){width="70%"}
...
section [1.5](#sec-nerfs:fitting){reference-type="ref"
reference="sec-nerfs:fitting"}, where we will find that volume rendering
...
![](figures/nerfs/flatland_volume_rendering.png){width="75%"}
...
will when using it in an optimization loop; see section
[1.3.1](#sec-nerfs:nerf_section){reference-type="ref"
reference="sec-nerfs:nerf_section"}) we will eventually take into
...
![](figures/nerfs/flatland_training.jpg){width=".9"}
