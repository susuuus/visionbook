...
![Learning is an algorithm that outputs algorithms.](./figures/intro_to_learning/learning_as_meta_algorithm.png){#fig-learning_as_meta_algorithm}
...
![How your brain may have solved the star problem.](./figures/intro_to_learning/star_symbol_learning.png){#fig-star_symbol_learning}
...
![A complicated function that could be learned from examples. This example is from @hays2007scene. ](./figures/intro_to_learning/inpainting_example.png){#fig-intro_to_learning-inpainting_example}
