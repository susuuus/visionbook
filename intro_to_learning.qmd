...
![](./figures/intro_to_learning/learning_as_meta_algorithm.png){width="75%"}
...
![](./figures/intro_to_learning/star_symbol_learning.png){width="75%"}
...
![](./figures/intro_to_learning/inpainting_example.png){width="100%"}
...
of learning in part
[\[part:generative_models_and_representation_learning\]](#part:generative_models_and_representation_learning){reference-type="ref"
reference="part:generative_models_and_representation_learning"} of this
...
![](./figures/intro_to_learning/ols_train_test.png){width="100%"}
...
![](./figures/intro_to_learning/ols_fit.png){width="100%"}
...
![](./figures/intro_to_learning/ols_system_diagram.png){width="100%"}
...
finding two scalars. In chapter
[\[chapter-problem_of_generalization\]](#chapter:problem_of_generalization){reference-type="ref"
reference="chapter-problem_of_generalization"}, we will see some
pitfalls of using too powerful a hypothesis space when a simpler one
will do.

![](./figures/intro_to_learning/program_induction_system_diagram.png){width="100%"}
