...
::: {#fig-pinhole_interactive .quarto-figure}
<iframe 
  src="demos/simple_sys/pinhole.html?zoom=4" 
  width="100%" 
  height="500px" 
  style="border:none;">
</iframe>
Figure: Interactive demonstration of the pinhole camera geometry. Drag to rotate, scroll to zoom.
:::
