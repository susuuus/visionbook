...
:::{#fig-steerg2h2}
![Quadrature pair, $g_{xx](figures/spatial_filter_sets/steer_quad_aprox_a.png){width=100% #fig-steerg2h2}
...
![Polar plots of orientation energy as a
  function of angle, computed using $g_{xx](figures/spatial_filter_sets/steer_quad_polarplot_zebra_cube.png){width=100% #fig-multioriflorets_examples}
