...
[\[sec-blur_filters\]](#chap:blur_filters){reference-type="ref"
reference="sec-blur_filters"}) is the Gaussian function
...
![](figures/spatial_filter_sets/gabor_magnitude.png){width="50%"}
...
![](figures/temporal_filters/MT_velocity_tuned.png){width="100%"}
