# Multiview Geometry and Structure from Motion {#chapter-3D_multiview}
...
![](figures/sfm/demos_motivation-1.png){width=".7"}
...
reference="chap-stereo_vision"} and
[\[chapter-homography\]](#chapter:homography){reference-type="ref"
reference="chapter-homography"}) and that will be mentioned again
(chapter
[\[chap-optical_flow_estimation\]](#chap:optical_flow_estimation){reference-type="ref"
reference="chap-optical_flow_estimation"}).
...
[\[chap-stereo_vision\]](#chap:stereo_vision){reference-type="ref"
reference="chap-stereo_vision"} we had to find matching points across
...
![](figures/sfm/toy_keypoint_detector-1.png){width="100%"}
...
than the ones detected on the sugar bowl.
  ...
  -------------------------------------------------------------------------------
    ![](figures/sfm/sugar/sugar_keypoints_examples_many-1.png){width="100%"}
                                       \(a\)
  -------------------------------------------------------------------------------

  -------------------------------------------------------------------------------
    ![](figures/sfm/palma/palma_keypoints_examples_many-1.png){width="100%"}
                                       \(b\)
  -------------------------------------------------------------------------------
...
In chapter
[\[chap-stereo_vision\]](#chap:stereo_vision){reference-type="ref"
reference="chap-stereo_vision"} we described SIFT @Lowe04 as a local
...
![](figures/sfm/sugar/point_cloud_key_points_figure-1.png){width="100%"}
...
multiple views.
  ...
  --------------------------------------------------------------------------------
    ![](figures/sfm/sugar/sugar_keypoint_matching_figure-1.png){width="100%"}
                                       \(a\)
  --------------------------------------------------------------------------------

  --------------------------------------------------------------------------------
    ![](figures/sfm/palma/palma_keypoint_matching_figure-1.png){width="100%"}
                                       \(b\)
  --------------------------------------------------------------------------------
...
[\[chap-stereo_vision\]](#chap:stereo_vision){reference-type="ref"
reference="chap-stereo_vision"}. Then, we add another image and we
...
in this chapter.
  ...
  ---------------------------------------------------------------------------------
   ![](figures/sfm/sugar/point_cloud_sugar_view1-1.png){width=".46"}
                                        \(a\)
  ---------------------------------------------------------------------------------

  ---------------------------------------------------------------------------------
   ![](figures/sfm/sugar/point_cloud_sugar_view2-1.png){width=".46"}
                                        \(b\)
  ---------------------------------------------------------------------------------

  ------------------------------------------------------------------------
   ![](figures/sfm/palma/3d_palma_view2-1.png){width=".46"}
                                   \(a\)
  ------------------------------------------------------------------------

  ------------------------------------------------------------------------
   ![](figures/sfm/palma/3d_palma_view1-1.png){width=".46"}
                                   \(b\)
  ------------------------------------------------------------------------
