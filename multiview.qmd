...
![Eight pictures taken in a plaza in Palma de Mallorca, Spain. The images have $3,024 \times 4,032$ pixels.](figures/sfm/palma/IMG_1643.jpeg){width=".24" #fig-sfm-palma}
...
than the ones detected on the sugar bowl.
  ...
  -------------------------------------------------------------------------------
    ![Each patch shows a $65 \times 65$ image crop centered on a detected keypoint. The keypoint detector finds image regions with strong spatial changes. Those regions are also likely to be found on images of the same object but under different viewpoints. (a) Sugar bowl, \fig{\ref{fig-sfm-sugar](figures/sfm/sugar/sugar_keypoints_examples_many.png){width="100%" #fig-sfm-sugar_keypoints_examples_many}
                                       \(a\)
  -------------------------------------------------------------------------------
...
multiple views.
  ...
  --------------------------------------------------------------------------------
    ![Matching keypoints across different viewpoints. For each subfigure, the top row shows the location of a matching keypoint across several views. The bottom row shows crops of size $129 \times 129$ pixels around each the keypoint.](figures/sfm/sugar/sugar_keypoint_matching_figure.png){width="100%" #fig-sfm-palma_keypoint_matching_figure}
                                       \(a\)
  --------------------------------------------------------------------------------
...
in this chapter.
  ...
  ---------------------------------------------------------------------------------
   ![3D reconstruction of the sugar bowl. The figure shows two different viewpoints and the recovered camera locations. (a) Bird's view. (b) Side view.](figures/sfm/sugar/point_cloud_sugar_view1.png){width=".46" #fig-sfm-3dsugar}
                                        \(a\)
  ---------------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------
   ![3D reconstruction of the plaza. The figure shows two different viewpoints and the recovered camera locations. (a) Bird's view.  (b) Arbitrary view.](figures/sfm/palma/3d_palma_view2.png){width=".46" #fig-sfm-3dpalma}
                                   \(a\)
  ------------------------------------------------------------------------
