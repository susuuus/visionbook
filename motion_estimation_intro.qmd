# Motion Estimation {#chapter-motion_estimation}
...
![](figures/optical_flow/050822_172806__MG_5366.jpg){width=".7"}
...
![](figures/optical_flow/moving_bike-1.png){width="100%"}
...
[\[chapter-filter_banks\]](#chapter:filter_banks){reference-type="ref"
...
a few moving objects, as shown in @fig-two_frames_from_palma_street.
  ...
  --------------------------------------------------------
   ![](figures/optical_flow/frame1.jpg){width="48%"}
                         (Frame 1)
  --------------------------------------------------------
...
[\[chapter-perceptual_organization\]](#chapter:perceptual_organization){reference-type="ref"
...
![](figures/optical_flow/matching_cost_figure-1.png){width="100%"}
...
![](figures/optical_flow/matching_optical_flow_patch_size_effect-1.png){width=".8"}
...
[\[chapter-temporal_filters\]](#chapter:temporal_filters){reference-type="ref"
reference="chapter-temporal_filters"}.

![](figures/optical_flow/ted_demo_motion_1-1.png){width="100%"}

The signals, and magnitudes of their space-time Fourier transforms, are
developed in
figures [\[fig:motionIllusion1\]](#fig-motionIllusion1){reference-type="ref"
reference="fig:motionIllusion1"} and
...
![](figures/optical_flow/ted_demo_motion_2-1.png){width="100%"}
