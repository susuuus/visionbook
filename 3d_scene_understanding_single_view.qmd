...
![](figures/imaging_geometry/horizon_line.png){width=".9" #fig-horizon_line_cross_products}
...
![](figures/single_view_3d/4_colinear_points.png){width=".25"}
...
![Projection of desk height onto the bookshelf. We start with the bottom and top image coordinates of points along vertical edges of the bookshelf: $\mathbf{t}$](figures/single_view_3d/office_measuring_desk.png){width="85%" #fig-office_measuring_desk}
...
![Sketch of the setting from @fig-office_measuring_desk](figures/single_view_3d/office_measuring_desk_sketch.png){width="70%" #fig-office_measuring_desk_sketch}
...
@sec-simple_unreliable_calibration_method); (2) used a
calibration pattern (section
@sec-simple_unreliable_calibration_metho); and (3) used a
