...
![The image shows how scene understanding is possible from simple 3D cues and context. This sketch is a recreation of a real photograph shown in \cite{Biederman1976](figures/single_view_3d/streetgeons.png){width=".8" #fig-streetgeons}
...
![Make your own Ames room. Take a picture of this page and print it as large as you can (A4 or letter size will be sufficient). When you look through the aperture on the {\em front wall](figures/single_view_3d/ames_room.png){width=".8" #fig-ames_room}
...
![The {\em leaning tower illusion](figures/single_view_3d/LeaningTower1.jpg){width="100%" #fig-LeaningTower1}
...
![](figures/imaging_geometry/horizon_line.png){width=".9"}
...
![](figures/single_view_3d/office_vanishing_points_3.png){width="100%"}
...
![](figures/single_view_3d/4_colinear_points.png){width=".25"}The cross-ratio is considered the most important projective invariant.
...
![The set of points $\mathbf{P](figures/single_view_3d/cross_ratio_description2.png){width=".9" #fig-cross_ratio_description}
...
$\mathbf{t](figures/single_view_3d/office_measuring_desk.png){width="85%" #fig-office_measuring_desk}
...
![Sketch of the setting from \fig{\ref{fig:office_measuring_desk](figures/single_view_3d/office_measuring_desk_sketch.png){width="70%" #fig-office_measuring_desk_sketch}
...
![Can we find out where to put the ticks in the world-coordinate axes as seen by the camera so that they correspond to calibrated measurements? Simply placing them at evenly spaced intervals along the three axes in the image won't be correct due to perspective projection.](figures/single_view_3d/office_world_calibration.png){width=".7" #fig-office_world_calibration}
...
![(a) In the absence of any other information, we can not recover the 3D location of point $\mathbf{P](figures/single_view_3d/locating_a_3d_point.png){width="100%" #fig-locating_a_3d_point}
...
chapter
[\[chapter-object_recognition\]](#sec-object_recognition){reference-type="ref"
