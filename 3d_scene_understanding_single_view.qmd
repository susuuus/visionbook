...
![The image shows how scene understanding is possible from simple 3D cues and context. This sketch is a recreation of a real photograph shown in @Biederman1976](figures/single_view_3d/streetgeons.png){width=".8" #fig-streetgeons}
...
![Using parallel lines, in homogeneous coordinates, to compute vanishing points and the horizon line.](figures/imaging_geometry/horizon_line.png){width=".9" #fig-horizon_line_cross_products}
