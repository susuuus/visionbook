...
![](figures/learning_3d/from_depthmap_2_pointcloud.png){width="100%"}
...
![](figures/learning_3d/encoder_decoder_arch.png){width="100%"}
...
![](figures/learning_3d/unsupervised_depth.png){width="100%"}
...
![](figures/learning_3d/geometry_reconstruction_12.png){width=".6"}
