# Learning to Estimate Depth from a Single Image {#chapter-3D_learning_from_single_image}
...
[\[sec-light_interacting_with_surfaces\]](#sec:light_interacting_with_surfaces){reference-type="ref"
reference="sec-light_interacting_with_surfaces"}. **Shape from shading**
...
and interreflections. We saw in chapter
[\[chap-looking_at_images\]](#chap:looking_at_images){reference-type="ref"
reference="chap-looking_at_images"}, @fig-cues_for_suppport an example
...
infer depth is in @Kaiming2009.
  ...
  ---------------------------------------------------------------------
   ![](figures/learning_3d/IMG_0508.JPG){width=".53"}
                                  \(a\)
  ---------------------------------------------------------------------
...
reconstruction as we already studied in chapter
[\[chapter-3D_single_view\]](#chapter:3D_single_view){reference-type="ref"
reference="chapter-3D_single_view"}.
...
which is related to the inverse of the depth as we saw in chapter
[\[chap-stereo_vision\]](#chap:stereo_vision){reference-type="ref"
reference="chap-stereo_vision"}.
...
intrinsic camera parameters, $\mathbf{K}$, of the sensor.
  ...
  ----------------------------------------------------------------
   ![](figures/learning_3d/rgb.jpg){width=".475"}
                               \(a\)
  ----------------------------------------------------------------
...
![](figures/learning_3d/from_depthmap_2_pointcloud-1.png){width="100%"}
...
![](figures/learning_3d/encoder_decoder_arch-1.png){width="100%"}
...
![](figures/learning_3d/unsupervised_depth-1.png){width="100%"}
...
![](figures/learning_3d/geometry_reconstruction_12-1.png){width=".6"}
...
[\[chapter-homography\]](#chapter:homography){reference-type="ref"
