...
We call this an **unconditional generative
...
A common choice is to use the , which is defined as
...
![](./figures/generative_models/max_likelihood_density.png){#fig-generative_models-max_likelihood_density width="100%"}
