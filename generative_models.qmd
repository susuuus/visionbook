...
:::{.column-margin}
Graphical model for generating $X \given Y, Z$.
![](./figures/generative_models/graphical_model_y_z_to_x_white.png){width="100%"}
:::
...
![](./figures/generative_models/graphical_model_z_to_x_white.png){width="100%"}
:::
...
![**Algorithm @fig-generative_models-simple_rivers_script}**: A simple generative model that draws images of rivers.](./figures/generative_models/simple_rivers_script.png){width="100%" #fig-generative_models-simple_rivers_script}
...
:::{#tbl-generative_models-types_of_gen_model}
...
![](./figures/generative_models/autoregressive_prediction_schematic.png){width="100%"}
