...
[\[chapter-gradient_descent\]](#sec-gradient_descent){reference-type="ref"
...
$$\begin{aligned}
\frac{\partial \frac{1}{N}\sum_{i=1}^N J_i(\theta)}{\partial \theta} = \frac{1}{N} \sum_{i=1}^N \frac{\partial J_i(\theta)}{\partial \theta}:average_of_gradients
\end{aligned}$${#eq-backpropagation} 
