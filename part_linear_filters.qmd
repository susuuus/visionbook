...
- **Chapter @sec-temporal_filters** extends filtering to the temporal domain, and describes applications of spatiotemporal filters for motion estimation, a topic that will be further extended in Chapter {@sec-understanding_motion}.
