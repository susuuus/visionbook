...
![](figures/temporal_filters/motion_illustration-1.png){width="100%"}
...
![](figures/temporal_filters/mov_pulse_012-1.png){width="100%"}
...
section [\[sec-spt_gaussian\]](#sec:spt_gaussian){reference-type="ref"
...
![](figures/temporal_filters/seq_filtered_kernel-1.png){width="100%"}
...
![](figures/temporal_filters/seq_filtered_blur-1.png){width="100%"}
...
![](figures/temporal_filters/gaussians_xyt_seq-1.png){width="100%"}
...
![](figures/temporal_filters/gaussians_xyt_section-1.png){width="100%"}
...
![](figures/temporal_filters/seq_filtered_der-1.png){width="100%"}
