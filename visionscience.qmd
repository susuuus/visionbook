...
pixels. It is so small that we can actually look at each single pixel
and think about how it is that we can make sense of it. For instance,
let's look at the pixel in row 21 counting from the top, and column 20
...
:::{.column-margin}
 Same image as in @fig-pexels-retha-ferguson but
shown small.\

![](figures/visionscience/DALLE_32x32.png){width=".20"}

\
Reducing the size helps better recognizing the objects despite
containing the same visual information. 
:::
...
![](figures/visionscience/principle_continuity_1-1.png){width=".6"}

\
Despite this, other groupings are also possible.\

![](figures/visionscience/principle_continuity_2-1.png){width=".6"}
