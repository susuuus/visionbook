...
contains thousands of tiny images within it @fig-tiny_images. A single photo can be
...
surface.](figures/visionscience/vertical_or_horizontal-1.png){#fig-vertical_or_horizontal
width="100%" }
