...
one.](figures/color/cd_spectrometer_setup.eps){#fig-colorWavelengths
width="100%"}
...
](figures/color/lightspectra_objects.eps){#fig-examples1 width="100%"}
...
<p><embed src="figures/color/Spectrum_of_blue_sky.eps"
...
light.](figures/color/cartoonColor2.eps){#fig-names width="100%"}
...
@venusta.](figures/color/flowerSpectra.eps){#fig-sourcerefl
width="100%"}
...
of . ](figures/color/nonblur_girls.eps){#fig-girls1 width="100%"}
...
](figures/color/blur_rgb_girls.eps){#fig-girls2 width="100%"}

![(a) Original image. (b) Lab components. (c) Lab components, each
blurred. These sharp and blurred components are used in the color images
of . ](figures/color/nonblur_lab_girls.eps){#fig-girls3 width="100%"}
...
of the image is sharp.](figures/color/blur_lab_girls.eps){#fig-girls4
width="100%"}
