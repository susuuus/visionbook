...
other colors.](figures/color/newtonDrawing.jpg){#fig-prism width=".9"}
...
![](figures/color/sunset_key_west.jpg){width=".4"}
:::
...
![](figures/color/Spectrum_of_blue_sky.png){width="70%"}   
   
...
:::{.column-margin}
Did you perceive the dress, \fig{\ref{fig:thedress}}, to be black on blue, or gold on white?  Can you make the perception change?
:::
...
![](figures/color/YYretina.png)

![](figures/color/Cones_SMJ2_E.jpg)

Fig (a) Measured cone receptor classes and positions in a human retina, with cone receptor classes shown as red, green, and blue (subject YY, redrawn from \cite{Hofer2005}).
...
From @eq-match2 it follows that
...
reproduction system are summarized below: 
...
The elements of the matrices $\mathbf{C}$ and $\mathbf{P}$ for an example color matching system.  (a) Spectral sensitivity curves, the rows of a color measurement matrix, $\mathbf{C}$. These should be linear combinations of the eye's photosensitivity curves, $\mathbf{C}_{\mbox{eye}}$.
(b) Corresponding primary lights, $\mathbf{P}$ \cite{Acdx2009},  satisfying $\mathbf{C} \mathbf{P}= \mathbf{I}_3$ ($\mathbf{M} = \mathbf{I}_3$  in @eq-conditions
:::
...
![](figures/color/nonblur_girls.png){width="100%"}

![](figures/color/blur_rgb_girls.png){width="100%"}

![](figures/color/nonblur_lab_girls.png){width="100%"}

![](figures/color/blur_lab_girls.png){width="100%"}
