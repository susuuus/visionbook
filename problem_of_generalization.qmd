...
![](./figures/problem_of_generalization/under_and_overfitting.png){#fig-under_and_overfitting}
...
![](./figures/problem_of_generalization/under_and_overfitting_vs_polyK.png){#fig-under_and_overfitting_vs_polyK}
...
overfit less than smaller nets. We discuss this further in @sec-problem_of_generalization_rethinking_generalization.
...
\end{aligned}$${#eq-problem_of_generalization_regularized_objective} 
...
@eq-problem_of_generalization_regularized_objective.

### Revisiting the $\star$ Problem {#sec-problem_of_generalization_star_problem_revisited}
...
following Python program @fig-problem_of_generalization_python_star_solution.

::: {#fig-problem_of_generalization_python_star_solution}
...
## Rethinking Generalization {#sec-problem_of_generalization_rethinking_generalization}
...
in @fig-problem_of_generalization_search_space_tools.
...
![A cartoon of the tools for honing in on the truth.](./figures/problem_of_generalization/search_space_tools.png){#fig-problem_of_generalization_search_space_tools}
...
\end{aligned}$${#eq-problem_of_generalization_error_fn_1} 


:::{.column_margin}
We use the exponent $0.25$, rather than the more common squared error, just so that the plots in @fig-problem_of_generalization_more_data_more_constraints show more clearly the linear constraints (the dark lines) added by each datapoint to the objective $J$.
:::

In @fig-problem_of_generalization_more_data_more_constraints, bottom row,
...
![More data, more (soft) constraints.](./figures/problem_of_generalization/more_data_more_constraints.png){#fig-problem_of_generalization_more_data_more_constraints}
...
@fig-problem_of_generalization_more_regularizer_more_constraints,
...
![More regularization, more (soft) constraints.](./figures/problem_of_generalization/more_regularizer_more_constraints.png){#fig-problem_of_generalization_more_regularizer_more_constraints}
...
@eq-problem_of_generalization_error_fn_1 and we will consider the
...
@fig-problem_of_generalization_fewer_hypotheses_more_constraints. We
show the hypothesis spaces in order of decreasing size moving to the
right.

![Fewer hypotheses, more (hard) constraints](./figures/problem_of_generalization/fewer_hypotheses_more_constraints.png){#fig-problem_of_generalization_fewer_hypotheses_more_constraints}
...
gray region in
@fig-problem_of_generalization_fewer_hypotheses_more_constraints can be
