...
into computer vision is still in print: *Vision*, by David Marr
@Marr2010. The intuitions are timeless and the writing is wonderful.
...
Vision* @Hartley2004. *Solid Shape* @KoenderinkSolidShape1990, by
Koenderink, offers a general treatment of three-dimensional (3D)
...
Computer Vision* @Trucco1998, by Trucco and Verri.
...
and Goodfellow, Bengio, and Courville @Goodfellow-et-al-2016.
Probabilistic models for vision are well covered in the textbook of
Simon Prince @princeCVMLI2012.
...
@Granlund95, covers many basics of low-level vision. Ullman insightfully
