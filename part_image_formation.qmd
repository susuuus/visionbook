...
- Images: We will use the $\ell$ symbol to denote images (i.e., $\ell$ight). We will also use the same symbol when referring to light rays and other physical quantities.
