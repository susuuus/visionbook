...
Let $\ell$ represent the light intensities in the world. We will also use $\boldsymbol{\ell}$ for vectors and matrices related to images and other signals. The notation $\mathcal{L}$ will refer to certain transformations of these signals.
