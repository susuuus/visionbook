# Stereo Vision {#chap-stereo_vision}
...
![](figures/3d_scene_understanding/titanic-1.png){width="100%"}
...
![](figures/3d_scene_understanding/boats-1.png){width="100%"}
...
![](figures/3d_scene_understanding/random_dot_stereogram-1.png){width="100%"}
...
We can also build a **stereo pinhole camera**. As we discussed in
chapter [\[chapter-imaging\]](#chapter:imaging){reference-type="ref"
reference="chapter-imaging"}, a pinhole camera is formed by a dark
...
![](figures/3d_scene_understanding/anaglyph_camera.png){width="100%"}
...
![](figures/3d_scene_understanding/triangularization_stereo-1.png){width="100%"}
...
![](figures/stereo/stereolamp.jpg){width="100%"}
...
[\[chapter-3D_multiview\]](#chapter:3D_multiview){reference-type="ref"
...
![](figures/3d_scene_understanding/epipolar_1-1.png){width="70%"}
...
![](figures/3d_scene_understanding/epipolar_3-1.png){width="70%"}
...
![](figures/3d_scene_understanding/epipolar_geometry-1.png){width="80%"}
...
![](figures/3d_scene_understanding/epipolar_game_play-1.png){width="100%"}
...
![](figures/stereo/stereocnn.jpg){width="100%"}
